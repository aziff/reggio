...
\quad \quad \quad Reggio& \highlight{0.02} & 0 & \textbf{     0.13} & . & \textbf{    -0.07} &      0.10 & & \highlight{0.22} & \textbf{     0.17} & \textbf{     0.31} & . & \textbf{     0.10} &      0.03 \\*
...
\quad \quad \quad Reggio& \highlight{0.04} & \textbf{    -0.08} & \textbf{     0.07} & \textbf{    -0.06} & \textbf{    -0.04} &      0.04 & & \highlight{0.09} & \textbf{     0.25} & \textbf{     0.13} & \textbf{0} & \textbf{     0.05} &      0.03 \\*
...
\quad \quad \quad Reggio& \highlight{0.04} & 0.26 & \textbf{     0.11} & \textbf{     0.08} & \textbf{     0.06} &      0.11 & & \highlight{0} & 0.25 & \textbf{     0.06} & 0 & 0.01 &      0.08 \\*
...
\textbf{Smokes} \\*[.1cm]
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.41} & 0.37 & \textbf{     0.30} & . & 0.36 &      0.20 & & \highlight{0.27} & \textbf{     0.14} & \textbf{     0.13} & . & \textbf{     0.11} &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.50} & 0.47 & \textbf{     0.34} & . & 0.23 &      0.29 & & \highlight{0.41} & \textbf{     0.33} & \textbf{     0.14} & . & 0.11 &      0.11 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{1.20} & . & 0.31 & . & \textbf{     0.48} &      0.15 & & \highlight{1.00} & . & 0.11 & . & \textbf{     0.32} &      0.09 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{13.64} & 13.01 & \textbf{    15.67} & . & \textbf{    12.00} &      0.22 & & \highlight{17.27} & \textbf{    15.00} & 17.71 & . & \textbf{    14.29} &      0.12 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{18.49} & 19.23 & 11.55 & . & 17.55 &      0.20 & & \highlight{16.80} & \textbf{    15.00} & 9.67 & . & \textbf{    14.81} &      0.16 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{14.42} & . & \textbf{    12.39} & . & 14.42 &      0.05 & & \highlight{15.00} & . & 15.38 & . & 15.00 &      0.00 \\*
...
\textbf{BMI} \\*[.1cm]
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{21.13} & \textbf{    22.23} & \textbf{    21.74} & . & \textbf{    20.56} &      0.12 & & \highlight{21.99} & \textbf{    23.06} & \textbf{    22.24} & . & \textbf{    21.15} &      0.08 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{24.06} & \textbf{    21.93} & 23.99 & \textbf{    21.03} & \textbf{    24.72} &      0.10 & & \highlight{23.11} & \textbf{    21.12} & 23.22 & \textbf{    20.08} & 23.05 &      0.04 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{24.32} & \textbf{    23.23} & 24.25 & \textbf{    22.98} & \textbf{    22.47} &      0.17 & & \highlight{25.48} & \textbf{    23.06} & \textbf{    24.62} & \textbf{    23.81} & \textbf{    22.67} &      0.10 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{4.13} & \textbf{     4.27} & \textbf{     4.09} & . & \textbf{     3.96} &      0.12 & & \highlight{4.22} & \textbf{     4.33} & \textbf{     4.15} & . & 3.93 &      0.08 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{3.75} & 3.72 & \textbf{     3.93} & \textbf{     3.45} & \textbf{     3.64} &      0.07 & & \highlight{3.83} & \textbf{     4.13} & \textbf{     4.04} & \textbf{     3.50} & \textbf{     3.72} &      0.06 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{2.91} & \textbf{     2.73} & \textbf{     3.12} & \textbf{     3.85} & \textbf{     3.19} &      0.04 & & \highlight{3.00} & \textbf{     2.75} & \textbf{     3.22} & \textbf{     4.00} & \textbf{     3.28} &      0.04 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{1.37} & \textbf{     1.17} & \textbf{     1.30} & . & 0.96 &      0.18 & & \highlight{1.50} & \textbf{     1.25} & \textbf{     1.38} & . & 1.18 &      0.06 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{1.16} & \textbf{     0.97} & \textbf{     1.03} & \textbf{     0.96} & \textbf{     1.00} &      0.04 & & \highlight{1.17} & \textbf{     1.00} & \textbf{     1.04} & \textbf{     1.00} & \textbf{     1.05} &      0.02 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{1.51} & \textbf{     1.32} & \textbf{     1.26} & . & \textbf{     1.38} &      0.14 & & \highlight{1.67} & \textbf{     1.25} & \textbf{     1.29} & . & \textbf{     1.28} &      0.01 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{-0.01} & \textbf{     0.05} & -0.01 & . & 0.07 &      0.06 & & \highlight{0} & \textbf{     0.06} & 0 & . & 0.07 &      0.04 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{-0.04} & \textbf{    -0.07} & \textbf{     0.03} & \textbf{    -0.06} & \textbf{    -0.08} &      0.10 & & \highlight{0.02} & \textbf{0} & \textbf{     0.09} & \textbf{0} & 0.02 &      0.02 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.01} & \textbf{    -0.02} & 0.03 & -0.01 & 0.02 &      0.05 & & \highlight{0} & 0 & \textbf{     0.06} & 0 & \textbf{     0.05} &      0.00 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{8.29} & \textbf{     6.63} & 14.80 & . & \textbf{     7.69} &      0.22 & & \highlight{10.22} & \textbf{     6.35} & 16.08 & . & \textbf{     7.83} &      0.10 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{10.89} & \textbf{     5.50} & \textbf{    12.94} & \textbf{     2.70} & 11.12 &      0.05 & & \highlight{9.02} & \textbf{     5.25} & \textbf{    10.30} & \textbf{0} & \textbf{     8.73} &      0.02 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{18.18} & \textbf{    13.46} & 17.30 & \textbf{    20.61} & \textbf{    15.97} &      0.11 & & \highlight{18.50} & \textbf{    12.00} & \textbf{    14.78} & 18.00 & \textbf{    12.56} &      0.03 \\*
