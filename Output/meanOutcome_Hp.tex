...
\quad \quad \quad Reggio& \highlight{0} & \textbf{     0.06} & \textbf{     0.09} & \textbf{    -0.12} & -0.12 &      0.10 & & \highlight{0.21} & \textbf{     0.26} & \textbf{     0.28} & \textbf{0} & \textbf{     0.11} &      0.02 \\*
...
\quad \quad \quad Reggio& \highlight{0.01} & \textbf{    -0.07} & \textbf{    -0.03} & \textbf{    -0.11} & \textbf{    -0.03} &      0.03 & & \highlight{\textbf{     0.13}} & \textbf{     0.18} & \textbf{     0.08} & \textbf{0} & \textbf{     0.09} &      0.01 \\*
...
\quad \quad \quad Reggio& \highlight{0.14} & \textbf{     0.13} & \textbf{     0.11} & \textbf{     0.04} & \textbf{     0.06} &      0.04 & & \highlight{0.11} & \textbf{     0.10} & \textbf{     0.07} & \textbf{0} & \textbf{     0.02} &      0.02 \\*
...
\textbf{Smokes} \\*[.1cm]
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.29} & \textbf{     0.34} & 0.28 & . & 0.30 &      0.04 & & \highlight{0.21} & \textbf{     0.23} & \textbf{     0.19} & . & \textbf{     0.16} &      0.00 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.37} & \textbf{     0.29} & \textbf{     0.30} & \textbf{     0.10} & \textbf{     0.25} &      0.05 & & \highlight{0.29} & 0.29 & \textbf{     0.21} & \textbf{0} & \textbf{     0.18} &      0.02 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.82} & \textbf{     0.36} & \textbf{     0.49} & . & \textbf{     0.43} &      0.08 & & \highlight{0.75} & \textbf{     0.25} & \textbf{     0.36} & . & 0.32 &      0.04 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{18.10} & \textbf{    16.19} & \textbf{    17.30} & . & 15.87 &      0.05 & & \highlight{16.47} & \textbf{    15.00} & \textbf{    16.14} & . & \textbf{    15.00} &      0.02 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{14.68} & \textbf{    16.89} & 10.76 & \textbf{    12.37} & \textbf{    15.48} &      0.15 & & \highlight{16.65} & \textbf{    18.00} & 12.64 & \textbf{    15.00} & \textbf{    17.00} &      0.09 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{22.32} & \textbf{    18.02} & \textbf{    13.14} & . & \textbf{    11.89} &      0.13 & & \highlight{25.00} & \textbf{    21.67} & \textbf{    17.00} & . & \textbf{    15.31} &      0.06 \\*
...
\textbf{BMI} \\*[.1cm]
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{22.13} & \textbf{    21.92} & 22.06 & \textbf{    24.50} & 21.51 &      0.26 & & \highlight{23.57} & \textbf{    23.07} & \textbf{    23.47} & \textbf{    26.83} & 22.67 &      0.04 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{23.55} & \textbf{    21.90} & \textbf{    23.79} & \textbf{    25.19} & \textbf{    24.24} &      0.16 & & \highlight{24.10} & 21.98 & \textbf{    24.38} & \textbf{    25.72} & \textbf{    24.51} &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{22.44} & \textbf{    22.80} & \textbf{    23.87} & \textbf{    22.05} & \textbf{    23.10} &      0.31 & & \highlight{25.22} & \textbf{    24.72} & \textbf{    24.90} & \textbf{    23.56} & \textbf{    24.30} &      0.01 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{4.19} & \textbf{     4.22} & \textbf{     4.31} & \textbf{     4.90} & \textbf{     4.06} &      0.14 & & \highlight{4.26} & 4.26 & \textbf{     4.38} & \textbf{     5.00} & 4.04 &      0.05 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{3.65} & \textbf{     3.54} & \textbf{     3.79} & \textbf{     3.54} & 3.50 &      0.08 & & \highlight{3.91} & \textbf{     4.00} & \textbf{     4.06} & \textbf{     3.80} & \textbf{     3.78} &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{2.85} & \textbf{     3.11} & \textbf{     2.93} & 4.30 & \textbf{     3.09} &      0.08 & & \highlight{3.11} & \textbf{     3.30} & 3.14 & 4.50 & \textbf{     3.30} &      0.05 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{1.34} & 1.11 & \textbf{     1.21} & \textbf{     0.99} & 1.00 &      0.08 & & \highlight{1.41} & 1.17 & \textbf{     1.25} & \textbf{     1.00} & 1.15 &      0.04 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{1.17} & \textbf{     1.04} & \textbf{     1.09} & \textbf{     1.04} & \textbf{     1.13} &      0.02 & & \highlight{1.14} & \textbf{     1.00} & \textbf{     1.06} & \textbf{     1.00} & \textbf{     1.10} &      0.01 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{1.34} & \textbf{     1.22} & 1.36 & \textbf{     1.13} & \textbf{     1.54} &      0.09 & & \highlight{1.37} & \textbf{     1.20} & \textbf{     1.22} & \textbf{     1.00} & \textbf{     1.32} &      0.01 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{-0.05} & \textbf{    -0.02} & \textbf{    -0.02} & \textbf{    -0.11} & 0.08 &      0.08 & & \highlight{0.05} & \textbf{     0.06} & \textbf{     0.07} & \textbf{0} & 0.16 &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{-0.05} & \textbf{    -0.04} & \textbf{    -0.03} & \textbf{    -0.10} & \textbf{    -0.03} &      0.06 & & \highlight{\textbf{     0.05}} & \textbf{     0.06} & \textbf{     0.06} & \textbf{0} & \textbf{     0.09} &      0.01 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{-0.01} & \textbf{     0.08} & \textbf{     0.08} & -0.02 & \textbf{     0.01} &      0.02 & & \highlight{0} & \textbf{     0.10} & \textbf{     0.11} & 0 & \textbf{     0.04} &      0.02 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{8.31} & \textbf{     6.06} & 11.43 & \textbf{    18.32} & \textbf{     8.02} &      0.23 & & \highlight{12.55} & 8.60 & 15.18 & \textbf{    25.00} & 10.44 &      0.06 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{10.83} & 6.84 & \textbf{    12.34} & \textbf{    10.04} & \textbf{    11.23} &      0.09 & & \highlight{11.37} & 7.65 & \textbf{    12.44} & \textbf{    10.75} & \textbf{    10.41} &      0.02 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{14.48} & \textbf{    13.09} & \textbf{    15.60} & 15.07 & 14.46 &      0.09 & & \highlight{16.63} & \textbf{    14.20} & \textbf{    15.39} & \textbf{    15.50} & \textbf{    13.83} &      0.01 \\*
