...
\adjustbox{max height=\dimexpr\textheight-5.5cm\relax,
           max width=\textwidth}{
\input{../../output/multiple-methods/combinedanalysis/combined_child_M_Other}}
\end{table}
\end{frame}
...
\adjustbox{max height=\dimexpr\textheight-5.5cm\relax,
           max width=\textwidth}{
\input{../../output/multiple-methods/combinedanalysis/combined_adol_M_Other}}
\end{table}
\end{frame}
...
\adjustbox{max height=\dimexpr\textheight-5.5cm\relax,
           max width=\textwidth}{
\input{../../output/multiple-methods/combinedanalysis/combined_adult30_M_Other}}
\end{table}
\end{frame}
...
\adjustbox{max height=\dimexpr\textheight-5.5cm\relax,
           max width=\textwidth}{
\input{../../output/multiple-methods/combinedanalysis/combined_adult30_M_None}}
\end{table}
\end{frame}
...
\adjustbox{max height=\dimexpr\textheight-5.5cm\relax,
           max width=\textwidth}{
\input{../../output/multiple-methods/combinedanalysis/combined_adult40_M_Other}}
\end{table}
\end{frame}
...
\adjustbox{max height=\dimexpr\textheight-5.5cm\relax,
           max width=\textwidth}{
\input{../../output/multiple-methods/combinedanalysis/combined_adult40_M_None}}
\end{table}
\end{frame}
