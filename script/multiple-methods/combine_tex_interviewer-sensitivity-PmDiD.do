...
global reglistadol				None Drop2526 Drop4018 Drop4073 Drop4091 DropAll   
global fulllistadol				None Drop2526 Drop4018 Drop4073 Drop4091 DropAll 
global reglistadollp			none drop2526 drop4018 drop4073 drop4091 dropall
global fulllistadollp			none drop2526 drop4018 drop4073 drop4091 dropall 

global reglistadult30			None Drop187 Drop4018 Drop4073 DropAll   
global fulllistadult30			None Drop187 Drop4018 Drop4073 DropAll
global reglistadult30lp			none drop187 drop4018 drop4073 dropall
global fulllistadult30lp		none drop187 drop4018 drop4073 dropall

global reglistadult40			None Drop187 Drop4018 Drop4073 DropAll   
global fulllistadult40			None Drop187 Drop4018 Drop4073 DropAll
global reglistadult40lp			none drop187 drop4018 drop4073 dropall
global fulllistadult40lp		none drop187 drop4018 drop4073 dropall
...
foreach coh in $cohort {
	...
	foreach out in ${`coh'_outcome_M} {
		...
		import delimited using "${git_reggio}/output/multiple-methods/combinedanalysis/csv/didpm_sens_`coh'_M_Other.csv", clear
		...
		* ------------------- *
		...
		file open tabfile`coh' using "${git_reggio}/output/multiple-methods/combinedanalysis/didpm_sens_`coh'_M_Other.tex", write replace
