...
global kernellistadult30		KM30
global fulllistadult30			None BIC Full PSM KM // order should be same as fulllistadultlp
global reglistadult30lp			none30 bic30 full30 
global psmlistadult30lp			psm30
global kernellistadult30lp		km30
global fulllistadult30lp		none30 bic30 full30 psm30 km30 

global reglistadult40			None30 BIC30 Full30
global psmlistadult40			PSM30
global kernellistadult40		KM30
global fulllistadult40			None BIC Full PSM KM // order should be same as fulllistadultlp
global reglistadult40lp			none30 bic30 full30 
global psmlistadult40lp			psm30
global kernellistadult40lp		km30
global fulllistadult40lp		none30 bic30 full30 psm30 km30 
	...
	foreach coh in $cohort {
		...
		foreach gr in ${group`coh'} {
			foreach out in ${outcome`coh'} {
				...
				import delimited using "${git_reggio}/output/multiple-methods/stepdown/csv/reg_`coh'_`out'_`gr'_`city'_sd.csv", clear
				
				tempfile reg_`coh'_`gr'
				save "`reg_`coh'_`gr''"
				
				import delimited using "${git_reggio}/output/multiple-methods/stepdown/csv/psm_`coh'_`out'_`gr'_`city'_sd.csv", clear
				...
				import delimited using "${git_reggio}/output/multiple-methods/stepdown/csv/kern_`coh'_`out'_`gr'_`city'_sd.csv", clear
				merge 1:1 rowname using `reg_`coh'_`gr''
				...
				* ------------------- *
				...
				file open tabfile`coh'`gr' using "${git_reggio}/output/multiple-methods/stepdown/combined_`coh'_`out'_`gr'_`city'_sd.tex", write replace
