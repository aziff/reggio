...
We present a basic specification of OLS to estimate the effect of the Reggio Approach on an outcome of interest, $Y$, compared to not attending preschool at all. For this abbreviated analysis, we restrict to individuals from Reggio Emilia who either attended a Reggio Approach preschool or did not attend any preschool. We further restrict to two cohorts: adults in their 30s and adults in their 40s. This allows us to focus on a uniform set of outcomes between the cohorts. We exclude the cohort of adults in their 50s because the Reggio Approach was not available to them.
