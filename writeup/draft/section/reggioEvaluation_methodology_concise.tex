...
Although the baseline OLS and DiD models attempt to account for the selection into the Reggio Approach, the regression estimator for ATE may be poorly estimated when the observed values of baseline variables are not similar for the treatment and control groups. We estimate an Augmented Inverse Propensity Weighted (AIPW) estimator in order to account for this. 
%\citep{Glynn_2010}. 
