...
Tables~\ref{tab:aipw} through~\ref{tab:aipw} show the results for the AIPW model discussed in Section~\ref{sec:aipw-mlogit}. 

\begin{table}[H] \caption{Augmented IPW, Cognitive and Education, Adult Cohorts} \label{ipw-adult-E}
	\input{../../output/ipw_mlogitadult_E}
