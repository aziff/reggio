...
\scalebox{0.8}{\input{../../output/multiple-methods/combinedanalysis/combined_adol_M_Other}}
\vspace{1ex} \\
...
\scalebox{0.75}{\input{../../output/multiple-methods/combinedanalysis/combined_adult_M_Other}}
\vspace{1ex} \\
...
\scalebox{0.75}{\input{../../output/multiple-methods/combinedanalysis/combined_adult_M_None}}
\vspace{1ex} \\
