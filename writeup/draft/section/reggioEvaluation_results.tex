...
\begin{table}[H] \caption{OLS, Diff-in-Diff, and PSM Results for Employment and Income, Preschools, Reggio Emilia} \label{ols-W-reg}
\scalebox{0.76}{
...
\begin{table}[H] \caption{OLS, Diff-in-Diff, and PSM Results for Living Environment, Preschools, Reggio Emilia} \label{ols-L-reg}
\scalebox{0.80}{
...
\begin{table}[H] \caption{OLS, Diff-in-Diff, and PSM Results for Health, Preschools, Reggio Emilia} \label{ols-H-reg}
\scalebox{0.77}{
...
\begin{table}[H] \caption{OLS, Diff-in-Diff, and PSM Results for Non-cognitive, Preschools, Reggio Emilia} \label{ols-N-reg}
\scalebox{0.80}{
...
\begin{table}[H] \caption{OLS, Diff-in-Diff, and PSM Results for Social Behavior, Preschools, Reggio Emilia} \label{ols-S-reg}
\scalebox{0.80}{
