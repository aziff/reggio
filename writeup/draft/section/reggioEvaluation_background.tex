...
We discuss the results of the survey in greater detail in the following descriptions of the municipal, including the Reggio Approach, state, and religious programs.
...
The results from the survey indicate that the municipal schools in Parma and Padova not only offered services helping more disadvantaged families, such as extended hours, but also prioritized enrollment for these families. These families included those of a low economic status in addition to those with a single parent or a child with a disability. 

Although starting in the 2000s all three municipal programs required teachers to document children's learning and stated that they were influenced by academic theories of psychology and early childhood interventions. 
