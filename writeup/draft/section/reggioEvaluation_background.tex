...
Table~\ref{tab:respondents} identifies the school systems in each city that completed our survey. We acknowledge that the small sample of survey respondents may be too limited to ensure reliable reporting of representative results.
...
While the Reggio Approach remains distinctive when considering the sum of its elements, the alternative systems surveyed in our study evolved to include a substantial portion of the elements in Reggio Emilia's municipal system. To better understand which features of the Reggio Approach were adopted by other programs and how they evolved, we document key components by decade and by each system in Table~\ref{tab:survey-data-main}. For the full set of Survey items and responses, see Appendix~\ref{sec:survey}.

\begin{table}[H]
	\caption{Key Reggio Approach Components Present in other Programs}\label{tab:survey-data-main}
\scriptsize
\centering
\begin{tabular}{L{4.5cm} C{0.7cm}  C{1.4cm}  C{1.4cm}  C{1.4cm}  C{1.4cm}  C{1.4cm}  C{1.4cm}}
\toprule																	
Policies to Support At-Risk Children and Working Families		&		&	Reggio Municipal	&	Reggio State	&	Parma Municipal	&	Padova Municipal	&	Padova State	&	Padova Religious	\\	\midrule
...
\toprule
Administrative Practices 	&		&	Reggio Municipal	&	Reggio State	&	Parma Municipal	&	Padova Municipal	&	Padova State	&	Padova Religious	\\	\midrule
\multirow{5}{4.5cm}{Parental boards or advisory groups are encouraged as active participants in school culture}	&	1960	&	\checkmark	&		&		&		&		&		\\	
	...
	&	1990	&	\checkmark	&	\checkmark	&	\checkmark	&	\checkmark	&		&	\checkmark	\\	
	&	2000	&	\checkmark	&	\checkmark	&	\checkmark	&	\checkmark	&		&	\checkmark	\\ \midrule
\multirow{5}{4.5cm}{Full-time, degreed Pedagogistas\footnote{A Pedagogista is a highly trained specialist in early childhood education or psychology. In some early childhood systems, this role is referred to as an Educative Coordinator; the training and responsibilities of Educative Coordinators vary across cities and ECE systems.} are hired by the system to oversee professional development for multiple program sites}	&	1960	&	\checkmark	&		&		&		&		&		\\	
	&	1970	&	\checkmark	&		&		&		&		&		\\	
	&	1980	&	\checkmark	&		&		&	\checkmark	&		&		\\	
	&	1990	&	\checkmark	&		&	\checkmark	&	\checkmark	&	\checkmark	&		\\	
	&	2000	&	\checkmark	&		&	\checkmark	&	\checkmark	&	\checkmark	&		\\	\midrule
\multirow{5}{4.5cm}{Professional development is provided by highly trained educational coordinators to each program site every 1-2 weeks\footnote{In Padova's religious programs, professional development is provided by a mix of part-time and full-time employees.}}	&	1960	&	\checkmark	&		&		&		&		&		\\	
	&	1970	&	\checkmark	&		&		&		&		&	\checkmark	\\	
	&	1980	&	\checkmark	&		&		&		&		&	\checkmark	\\	
	&	1990	&	\checkmark	&		&	\checkmark	&		&	\checkmark	&	\checkmark	\\	
	&	2000	&	\checkmark	&		&	\checkmark	&		&	\checkmark	&	\checkmark	\\	\midrule
...
\textbf{[JJH: How can a survey reveal spillovers or not?]} 
...
Survey results for religious preschools are available only for Padova. Evidence suggests that religious preschools in Padova share the following practices with the Reggio Approach: from the 1970s, weekly time was set aside for teachers to engage families and the same teacher remained with a cohort of children. Parental boards were actively engaged in school culture from the 1970s (see Appendix Table \ref{tab:programoperation}). From the 1980s, teachers documented children's work and school environments included an atelier, or dedicated room where children worked together (see Appendix Table \ref{tab:environ-features}). From the 1990s, Padova's religious schools prioritized enrollment for children with disabilities. 
...
\textbf{[JJH: This section is very weak and hurts the paper. Team: The following section has been revised.]}
...
On many key features, the Reggio Approach is not unique compared to other early childhood systems in Reggio Emilia and in neighboring cities of Northern Italy. The practices endorsed by Reggio Emilia that were never systemically adopted by the state and local programs we study reflect Dewey's progressive model. This approach prioritizes the process of learning over the learning of content; in Reggio Emilia, progressive early childhood education employs a strong focus on creativity and fine arts as a mechanism for learning. 

%Diffusion? Common founder? Other?
