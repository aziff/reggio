...
\input{../Output/pool_texAsiloChildCH_short.tex}  
\end{table}
\begin{table}[H]
\caption{Pool Regression: Child Health - Preschool, Child}
\input{../Output/pool_texMaternaChildCH_short.tex}
\end{table}

\begin{table}[H]
\caption{Pool Regression: Child SDQ Score - Infant-toddler center, Child}
\input{../Output/pool_texAsiloChildCS_short.tex}  
\end{table}
\begin{table}[H]
\caption{Pool Regression: Child SDQ Score - Preschool, Child}
\input{../Output/pool_texMaternaChildCS_short.tex}
\end{table}
\end{small}
