...
\input{../Output/new_pool_texMaternaChildAdolCS_short.tex}
\end{table}
\end{small}
...
\input{../Output/new_pool_texAsiloAdolAdultD_short.tex}
\end{table}
\begin{table}[H]
...
\input{../Output/new_pool_texAsiloAdolAdultM_short.tex}
\end{table}
\begin{table}[H]
