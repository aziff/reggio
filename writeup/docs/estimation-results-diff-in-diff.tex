...
%	\item \textbf{OLS results:} 
%	
%	\item \textbf{Diff-in-diff results:} 
%	\end{itemize}
%
%
%\end{itemize}
...
\begin{center}
		\scriptsize{
			\begin{longtable}{L{3cm} c c c c c c p{.5cm} c c c c c c} 
				...
				\toprule
				\input{../../Output/Mean_OLS/meanOutcome_E.tex}
			\end{longtable}
		}		
\end{center}
\end{landscape}
...
\begin{center}
		\scriptsize{
			\begin{longtable}{L{3cm} c c c c c c p{.5cm} c c c c c c}
				...
				\toprule \\
				\input{../../Output/Mean_OLS/meanOutcome_W.tex}
			\end{longtable}
		}		
\end{center}
\end{landscape}
...
\begin{center}
		\scriptsize{
			\begin{longtable}{L{3cm} c c c c c c p{.5cm} c c c c c c}
				...
				\toprule \\
				\input{../../Output/Mean_OLS/meanOutcome_L.tex}
			\end{longtable}
		}		
\end{center}
\end{landscape}
...
\begin{center}
		\scriptsize{
			\begin{longtable}{L{3cm} c c c c c c p{.5cm} c c c c c c}
				...
				\toprule \\
				\input{../../Output/Mean_OLS/meanOutcome_H.tex}
			\end{longtable}
		}		
\end{center}
\end{landscape}
...
%				\toprule \\
%				\input{../../Output/Mean_OLS/meanOutcome_N.tex}
%			\end{longtable}
%		}		
%\end{center}
%\end{landscape}
