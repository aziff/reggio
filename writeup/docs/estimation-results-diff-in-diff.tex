...
\item \textbf{IQ Factor:} 
	\begin{itemize}
	\item \textbf{OLS results:} Comparing different materna types within Reggio, the conditional mean (C.Mean) estimates of Table \ref{table:OLS_E} show that the mean IQ for individuals who attended Municipal preschools was significantly higher than the mean IQ for those who attended state schools and significantly lower than for those who attended Religious, Private or no preschools in the age 30 and 40 cohorts. A similar pattern holds for the uncontrolled means. 
	
	Comparing across cities, both the C.Mean and Mean estimates of Table \ref{table:OLS_E} show that individuals from all materna types in Parma and Padova significantly outpeform Municipal educated individuals from Reggio in the age 30 cohort. The C.Mean estimates show a similar pattern for the age 40 cohort except for State schools in Parma and Padova both of which have significantly lower mean IQ than Municipal educated individuals in Reggio. The mean estimates show a similar pattern.
...
\item \textbf{High school and University grades:} 
	\begin{itemize}
	\item \textbf{OLS results:} Looking within Reggio, Table \ref{table:OLS_E} shows that Municipal students from the age 30 cohort have significantly higher mean high school grades than all other Reggio materna students except those from private preschools. At the age 40 cohort, Reggio Municipal students significantly outperform only students who didn't attend preschool and significantly underperform those who attended State and Private school in terms of high school grades. 

In terms of university grades, Municipal students from the age 30 cohort have significantly higher mean grades than all other Reggio materna students except those from state preschools. For the age 40 cohort, Reggio Municipal educated individuals attain a significantly lower mean university grade than Religious students and significantly higher scores than State educated students.

Comparing across cities at the age 30 cohort, Municipal schools in Reggio significantly outperform almost all school types in Parma and Padova in terms of high school grades and university grades. This pattern persists for highschool grades in the age 40 cohort, but gets reversed for university grades in the age 40 cohort.
...
\item \textbf{Graduation from High School and University:} 
	\begin{itemize}
	\item \textbf{OLS results:} Comparing materna types within Reggio, Table \ref{table:OLS_E} shows that for the age 30 cohort, Municipal educated students have higher likelihood of graduating high school than those who didn't attend preschool, and lower likelihood than State and Private educated students. At age 40, Municipal educated students have a higher likelihood of graduating high school than Private students, and lower likelihood than State students and those who didn't preschool. 

underperform State and Private school educated people, while outperforming those who d


 We do not detect strong differences in likelihood of graduation between Municipal schools and other materna types within Reggio. Comparing across cities, Table \ref{table:OLS_E} shows that Municipal students from Reggio have lower likelihoods of graduating from high school and university compared to students from most materna types in Parma and Padova.
