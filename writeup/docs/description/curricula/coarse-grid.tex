...
% Authors: 			Sylvi Kuperman, Anna Ziff, Sidharth Moktan
...
The symbols of the table are as follows: \checkmark\ indicates that the school type for the corresponding city and cohort had that component; $\times$ indicates that the school type did not have that component; $\sim$ indicates that some of the schools within that school type had that component; n/a indicates that the school type was not available for the specified cohort and city; a blank space indicates that we are still compiling information to determine the presence of that component. \textbf{References for the tables are included in Section~\ref{sec:tabnotes}.}
...
\caption{Comparison of Different School Types to Reggio Approach, Reggio Emilia}\label{table:comparisonRE}
	\input{ReggioEmilia_componentsTable}
\begin{tablenotes}
