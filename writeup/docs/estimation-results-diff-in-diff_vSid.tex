...
\begin{center}
	...
	\scalebox{0.75}{
		\input{../../Output/description/OLSReggioAdult30E.tex}
	}
	\end{center}
\footnotesize
...
\begin{center}
	...
	\scalebox{0.75}{
		\input{../../Output/description/OLSReggioAdult40E.tex}
	}
	\end{center}
	\footnotesize
...
\begin{center}
	...
	\scalebox{0.75}{
		\input{../../Output/description/OLSReggioAdult50E.tex}
	}
	\end{center}
	\footnotesize
...
\begin{center}
	...
	\scalebox{0.72}{
		\input{../../Output/description/OLSParmaAdult30E.tex}
	}
	\end{center}
	\footnotesize
...
\begin{center}
	...
	\scalebox{0.72}{
		\input{../../Output/description/OLSParmaAdult40E.tex}
	}
	\end{center}
	\footnotesize
...
\begin{center}
	...
	\scalebox{0.75}{
		\input{../../Output/description/OLSParmaAdult50E.tex}
	}
	\end{center}
	\footnotesize
...
\begin{center}
	...
	\scalebox{0.73}{
		\input{../../Output/description/OLSPadovaAdult30E.tex}
	}
	\end{center}
	\footnotesize
...
\begin{center}
	...
	\scalebox{0.73}{
		\input{../../Output/description/OLSPadovaAdult40E.tex}
	}
	\end{center}
	\footnotesize
...
\begin{center}
	...
	\scalebox{0.75}{
		\input{../../Output/description/OLSPadovaAdult50E.tex}
	}
	\end{center}
	\footnotesize
...
%	\scalebox{0.80}{
%		\input{../../Output/DiD/bic/didReggio_Ep}}
%\end{center}
%\footnotesize
...
\begin{center}
	...
	\scalebox{0.68}{
		\input{../../Output/description/OLSReggioAdult30W.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-30 people living in Reggio across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.68}{
		\input{../../Output/description/OLSReggioAdult40W.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-40 people living in Reggio across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.68}{
		\input{../../Output/description/OLSReggioAdult50W.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-50 people living in Reggio across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.68}{
		\input{../../Output/description/OLSParmaAdult30W.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-30 people living in Parma across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.68}{
		\input{../../Output/description/OLSParmaAdult40W.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-40 people living in Parma across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.68}{
		\input{../../Output/description/OLSParmaAdult50W.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-50 people living in Parma across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.68}{
		\input{../../Output/description/OLSPadovaAdult30W.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-30 people living in Padova across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.68}{
		\input{../../Output/description/OLSPadovaAdult40W.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-40 people living in Padova across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.68}{
		\input{../../Output/description/OLSPadovaAdult50W.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-50 people living in Padova across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.76}{
		\input{../../Output/description/OLSReggioAdult30L.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-30 people living in Reggio across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.76}{
		\input{../../Output/description/OLSReggioAdult40L.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-40 people living in Reggio across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.76}{
		\input{../../Output/description/OLSReggioAdult50L.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-50 people living in Reggio across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.76}{
		\input{../../Output/description/OLSParmaAdult30L.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-30 people living in Parma across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.76}{
		\input{../../Output/description/OLSParmaAdult40L.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-40 people living in Parma across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.76}{
		\input{../../Output/description/OLSParmaAdult50L.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-50 people living in Parma across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.76}{
		\input{../../Output/description/OLSPadovaAdult30L.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-30 people living in Padova across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.76}{
		\input{../../Output/description/OLSPadovaAdult40L.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-40 people living in Padova across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.76}{
		\input{../../Output/description/OLSPadovaAdult50L.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-50 people living in Padova across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.73}{
		\input{../../Output/description/OLSReggioAdult30H.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-30 people living in Reggio across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.73}{
		\input{../../Output/description/OLSReggioAdult40H.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-40 people living in Reggio across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.73}{
		\input{../../Output/description/OLSReggioAdult50H.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-50 people living in Reggio across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.73}{
		\input{../../Output/description/OLSParmaAdult30H.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-30 people living in Parma across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.73}{
		\input{../../Output/description/OLSParmaAdult40H.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-40 people living in Parma across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.73}{
		\input{../../Output/description/OLSParmaAdult50H.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-50 people living in Parma across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.73}{
		\input{../../Output/description/OLSPadovaAdult30H.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-30 people living in Padova across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.73}{
		\input{../../Output/description/OLSPadovaAdult40H.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-40 people living in Padova across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.73}{
		\input{../../Output/description/OLSPadovaAdult50H.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-50 people living in Padova across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.80}{
		\input{../../Output/description/OLSReggioAdult30N.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-30 people living in Reggio across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.80}{
		\input{../../Output/description/OLSReggioAdult40N.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-40 people living in Reggio across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.80}{
		\input{../../Output/description/OLSReggioAdult50N.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-50 people living in Reggio across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.80}{
		\input{../../Output/description/OLSParmaAdult30N.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-30 people living in Parma across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.80}{
		\input{../../Output/description/OLSParmaAdult40N.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-40 people living in Parma across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.80}{
		\input{../../Output/description/OLSParmaAdult50N.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-50 people living in Parma across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.80}{
		\input{../../Output/description/OLSPadovaAdult30N.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-30 people living in Padova across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.80}{
		\input{../../Output/description/OLSPadovaAdult40N.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-40 people living in Padova across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
...
\begin{center}
	...
	\scalebox{0.80}{
		\input{../../Output/description/OLSPadovaAdult50N.tex}
	}
	\end{center}
	\footnotesize
\underline{Note:} This table shows both unconditional and conditional OLS results for age-50 people living in Padova across different materna types. For each school type, ``Mean" column shows the unconditional mean and ``C. Mean" column shows the conditional mean. Bold number indicates that the corresponding mean is significantly different at the 10 \% level from the mean of individuals in the same restricted group who attended municipal schools.
