...
\input{tables/adol_outcomes_ed_asilo_Reggio}
\end{table}
...
\input{tables/adol_outcomes_ed_asilo_ParmaPadova}
\end{table}
...
%% adolescents, infant-toddler
\input{tables/child_CONTROLasilo.tex}
%\end{table}

%% adolescents, infant-toddler
\input{tables/child_CONTROLmaterna.tex}
%\end{table}

%% adolescents, infant-toddler
\input{tables/adol_CONTROLasilo.tex}
%\end{table}

%% adolescents, infant-toddler
\input{tables/adol_CONTROLmaterna.tex}
%\end{table}
...
\include{tables/resultsAdo-reggio}
\include{tables/resultsAdo-parmapadova}
\include{tables/resultsAdo-all}
