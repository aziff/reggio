...
\quad \quad \quad Reggio& \highlight{0.93} & \textbf{     0.92} & \textbf{     0.96} & 0.92 & \textbf{     0.90} &      0.04 & & \highlight{\textbf{     0.97}} & \textbf{     0.94} & \textbf{     1.00} & \textbf{     1.00} & 0.89 &      0.03 \\*
...
\quad \quad \quad Reggio& \highlight{1.03} & \textbf{     0.99} & \textbf{     1.02} & 0.81 & 0.96 &      0.19 & & \highlight{\textbf{     0.98}} & \textbf{     0.94} & \textbf{     0.98} & 0.80 & 0.91 &      0.03 \\*
...
\quad \quad \quad Reggio& \highlight{1.04} & \textbf{     0.97} & \textbf{     0.94} & 0.53 & 1.00 &      0.20 & & \highlight{1.00} & \textbf{     0.90} & \textbf{     0.82} & 0.50 & \textbf{     0.91} &      0.03 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0} & 0 & 0 & 0 & 0 &      1.00 & & \highlight{0.12} & \textbf{     0.07} & \textbf{     0.13} & 1.00 & \textbf{     0.17} &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0} & 0 & 0 & 0 & 0 &      1.00 & & \highlight{0.16} & \textbf{     0.18} & \textbf{     0.15} & \textbf{     0.40} & \textbf{     0.11} &      0.01 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0} & 0 & 0 & 0 & 0 &      1.00 & & \highlight{0.11} & \textbf{     0.20} & \textbf{0} & \textbf{0} & 0.12 &      0.02 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{43.29} & \textbf{    42.94} & \textbf{    41.50} & \textbf{    44.17} & 38.36 &      0.27 & & \highlight{42.24} & \textbf{    40.33} & 39.90 & \textbf{    50.00} & 35.77 &      0.11 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{37.24} & \textbf{    37.67} & \textbf{    38.25} & 29.42 & 34.49 &      0.39 & & \highlight{42.71} & \textbf{    43.33} & 42.88 & \textbf{    38.00} & 37.97 &      0.05 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{39.93} & 39.31 & \textbf{    38.56} & 40.26 & 39.57 &      0.39 & & \highlight{40.50} & 40.75 & \textbf{    38.91} & 40.00 & 40.61 &      0.01 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{1234.73} & \textbf{  1285.30} & \textbf{  1288.86} & 2108.66 & 1518.58 &      0.41 & & \highlight{1068.74} & \textbf{  1005.56} & \textbf{  1122.67} & 2000.00 & 1257.14 &      0.04 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{587.66} & \textbf{  1909.84} & \textbf{  1177.70} & \textbf{   207.04} & 1732.52 &      0.32 & & \highlight{1856.63} & \textbf{  2592.22} & \textbf{  2185.29} & \textbf{  1000.00} & \textbf{  2706.05} &      0.01 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{1396.60} & 1467.73 & 1451.06 & \textbf{  2082.38} & 1432.45 &      0.34 & & \highlight{1300.00} & 1316.67 & \textbf{  1600.00} & \textbf{  2000.00} & \textbf{  1457.53} &      0.05 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{-0.02} & \textbf{    -0.08} & \textbf{    -0.06} & \textbf{    -0.13} & -0.21 &      0.21 & & \highlight{0.15} & \textbf{     0.13} & \textbf{     0.10} & \textbf{0} & 0 &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{\textbf{    -0.02}} & \textbf{    -0.03} & \textbf{    -0.02} & \textbf{    -0.02} & \textbf{    -0.01} &      0.08 & & \highlight{0} & 0.06 & 0 & 0 & \textbf{     0.01} &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{-0.03} & \textbf{    -0.06} & -0.02 & -0.02 & \textbf{    -0.01} &      0.16 & & \highlight{0} & 0 & \textbf{     0.04} & 0 & \textbf{     0.01} &      0.01 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{\textbf{     0.04}} & \textbf{     0.03} & \textbf{     0.04} & 0.05 & \textbf{     0.03} &      0.05 & & \highlight{\textbf{     0.01}} & \textbf{0} & \textbf{0} & 0 & 0.04 &      0.01 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{\textbf{0}} & \textbf{0} & \textbf{0} & 0.20 & \textbf{0} &      0.23 & & \highlight{0} & 0 & 0 & 0.20 & 0 &      0.20 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.39} & \textbf{     0.36} & \textbf{     0.44} & \textbf{     0.27} & 0.59 &      0.09 & & \highlight{0.28} & \textbf{     0.23} & \textbf{     0.35} & \textbf{0} & 0.47 &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.44} & \textbf{     0.42} & \textbf{     0.40} & \textbf{     0.56} & \textbf{     0.49} &      0.10 & & \highlight{0.30} & \textbf{     0.35} & \textbf{     0.23} & \textbf{     0.40} & \textbf{     0.35} &      0.01 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.99} & \textbf{     0.85} & \textbf{     0.73} & \textbf{     1.18} & \textbf{     0.90} &      0.14 & & \highlight{0.33} & \textbf{     0.20} & \textbf{     0.07} & \textbf{     0.50} & \textbf{     0.29} &      0.03 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.58} & \textbf{     0.68} & \textbf{     0.62} & \textbf{     0.86} & 0.56 &      0.09 & & \highlight{0.53} & \textbf{     0.61} & \textbf{     0.55} & \textbf{     1.00} & \textbf{     0.46} &      0.01 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.52} & \textbf{     0.50} & \textbf{     0.42} & \textbf{     0.28} & \textbf{     0.42} &      0.09 & & \highlight{0.62} & \textbf{     0.53} & \textbf{     0.54} & \textbf{     0.40} & \textbf{     0.54} &      0.01 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.06} & \textbf{     0.25} & \textbf{     0.22} & \textbf{    -0.06} & 0.13 &      0.09 & & \highlight{0.67} & \textbf{     0.80} & \textbf{     0.71} & \textbf{     0.50} & \textbf{     0.63} &      0.01 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.01} & \textbf{0} & \textbf{    -0.03} & \textbf{    -0.05} & \textbf{     0.03} &      0.11 & & \highlight{0.04} & \textbf{     0.03} & \textbf{0} & \textbf{0} & 0.04 &      0.01 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.06} & \textbf{     0.05} & 0.17 & \textbf{     0.04} & \textbf{     0.04} &      0.26 & & \highlight{0.06} & \textbf{0} & 0.15 & \textbf{0} & \textbf{     0.04} &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{-0.01} & -0.05 & \textbf{     0.08} & \textbf{    -0.10} & -0.02 &      0.11 & & \highlight{0} & 0 & 0.18 & 0 & \textbf{     0.08} &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{-0.01} & \textbf{     0.05} & \textbf{     0.03} & \textbf{    -0.06} & 0.05 &      0.10 & & \highlight{\textbf{     0.02}} & \textbf{     0.06} & \textbf{     0.08} & \textbf{0} & \textbf{     0.06} &      0.01 \\*
