...
\quad \quad \quad Reggio& \highlight{0.98} & 0.90 & \textbf{     0.99} & 0.98 & \textbf{     1.00} &      0.05 & & \highlight{0.97} & \textbf{     0.92} & \textbf{     1.00} & \textbf{     1.00} & \textbf{     0.96} &      0.01 \\*
...
\quad \quad \quad Reggio& \highlight{1.05} & \textbf{     1.08} & \textbf{     1.02} & \textbf{     1.09} & \textbf{     1.01} &      0.13 & & \highlight{1.00} & 1.00 & \textbf{     0.97} & 1.00 & 0.92 &      0.04 \\*
...
\quad \quad \quad Reggio& \highlight{0.90} & 0.90 & \textbf{     0.85} & 0.91 & \textbf{     0.86} &      0.16 & & \highlight{1.00} & 1.00 & \textbf{     0.90} & 1.00 & \textbf{     0.97} &      0.02 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0} & 0 & 0 & 0 & 0 &      1.00 & & \highlight{0.16} & \textbf{0} & \textbf{     0.19} & 1.00 & 0.17 &      0.05 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0} & 0 & 0 & 0 & 0 &      1.00 & & \highlight{0.19} & \textbf{     0.11} & \textbf{     0.17} & 0.67 & \textbf{     0.11} &      0.04 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0} & 0 & 0 & 0 & 0 &      1.00 & & \highlight{0.17} & \textbf{     0.33} & \textbf{0} & \textbf{0} & \textbf{     0.09} &      0.06 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{41.76} & 41.33 & \textbf{    40.56} & \textbf{    42.76} & 35.64 &      0.28 & & \highlight{42.87} & \textbf{    41.00} & \textbf{    40.96} & \textbf{    50.00} & 34.55 &      0.15 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{38.58} & 38.79 & 38.66 & \textbf{    34.18} & 34.41 &      0.37 & & \highlight{45.00} & \textbf{    44.29} & \textbf{    44.00} & \textbf{    44.00} & 39.72 &      0.05 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{39.08} & 39.03 & 38.85 & 39.60 & 39.23 &      0.43 & & \highlight{40.80} & 41.17 & 40.62 & 40.00 & \textbf{    41.84} &      0.01 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{1424.19} & \textbf{  1203.58} & \textbf{  1365.44} & 2291.86 & \textbf{  1622.18} &      0.45 & & \highlight{1162.12} & \textbf{   925.00} & \textbf{  1134.00} & 2000.00 & \textbf{  1306.67} &      0.06 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{139.63} & \textbf{  1755.99} & 357.37 & . & 1789.04 &      0.45 & & \highlight{2225.00} & \textbf{  3163.33} & \textbf{  1702.94} & . & \textbf{  3084.55} &      0.02 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{1153.02} & 1153.02 & 1184.46 & \textbf{  2080.51} & 1186.01 &      0.38 & & \highlight{1316.67} & 1316.67 & 1450.00 & \textbf{  2000.00} & \textbf{  1456.57} &      0.04 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{-0.07} & \textbf{     0.04} & -0.08 & \textbf{    -0.19} & -0.21 &      0.22 & & \highlight{0.10} & \textbf{     0.23} & \textbf{     0.07} & \textbf{0} & \textbf{0} &      0.04 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{-0.04} & \textbf{    -0.06} & -0.04 & \textbf{    -0.07} & \textbf{    -0.02} &      0.15 & & \highlight{0} & 0 & 0 & 0 & \textbf{     0.03} &      0.02 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0} & 0 & 0 & 0 & 0 &         . & & \highlight{0} & 0 & 0 & 0 & 0.04 &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.01} & \textbf{     0.02} & 0.01 & 0.34 & 0.01 &      0.35 & & \highlight{0} & 0 & 0 & 0.33 & 0 &      0.33 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.54} & \textbf{     0.66} & \textbf{     0.60} & 0.56 & \textbf{     0.71} &      0.13 & & \highlight{0.24} & \textbf{     0.31} & \textbf{     0.33} & \textbf{0} & 0.44 &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.34} & \textbf{     0.44} & \textbf{     0.28} & \textbf{0} & \textbf{     0.44} &      0.14 & & \highlight{0.26} & \textbf{     0.44} & \textbf{     0.21} & \textbf{0} & \textbf{     0.35} &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.70} & 0.30 & 0.28 & \textbf{     0.24} & 0.35 &      0.14 & & \highlight{0.50} & \textbf{     0.17} & 0.10 & \textbf{0} & 0.17 &      0.05 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.48} & \textbf{     0.25} & 0.47 & \textbf{     0.65} & \textbf{     0.44} &      0.11 & & \highlight{0.61} & \textbf{     0.38} & \textbf{     0.59} & \textbf{     1.00} & \textbf{     0.48} &      0.02 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.67} & \textbf{     0.48} & \textbf{     0.58} & \textbf{     0.76} & 0.49 &      0.16 & & \highlight{0.65} & \textbf{     0.44} & \textbf{     0.55} & 0.67 & \textbf{     0.51} &      0.02 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.18} & \textbf{     0.59} & 0.67 & \textbf{     0.77} & \textbf{     0.54} &      0.15 & & \highlight{0.50} & \textbf{     0.83} & 0.90 & \textbf{     1.00} & \textbf{     0.75} &      0.04 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.05} & 0.05 & \textbf{     0.01} & \textbf{    -0.02} & \textbf{     0.06} &      0.17 & & \highlight{0.05} & \textbf{     0.08} & \textbf{0} & \textbf{0} & \textbf{     0.04} &      0.01 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.11} & \textbf{     0.13} & 0.29 & 0.10 & 0.10 &      0.33 & & \highlight{0.05} & \textbf{0} & 0.24 & \textbf{0} & \textbf{     0.03} &      0.09 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.12} & 0.11 & \textbf{     0.05} & \textbf{0} & 0.10 &      0.15 & & \highlight{0} & 0 & 0 & 0 & \textbf{     0.07} &      0.02 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{-0.09} & \textbf{0} & \textbf{    -0.12} & \textbf{    -0.13} & -0.02 &      0.22 & & \highlight{0.04} & \textbf{     0.11} & \textbf{0} & \textbf{0} & \textbf{     0.08} &      0.02 \\*
