...
\quad \quad \quad Reggio& \highlight{0.02} & \textbf{     0.19} & \textbf{     0.09} & \textbf{    -0.09} & \textbf{    -0.12} &      0.10 & & \highlight{0.20} & \textbf{     0.38} & \textbf{     0.26} & \textbf{0} & \textbf{     0.11} &      0.03 \\*
...
\quad \quad \quad Reggio& \highlight{0.01} & \textbf{    -0.05} & \textbf{    -0.09} & \textbf{    -0.15} & 0 &      0.05 & & \highlight{0.15} & \textbf{     0.11} & \textbf{     0.03} & \textbf{0} & 0.14 &      0.02 \\*
...
\quad \quad \quad Reggio& \highlight{0.19} & \textbf{     0.02} & \textbf{     0.13} & \textbf{     0.01} & \textbf{     0.05} &      0.04 & & \highlight{0.17} & \textbf{0} & \textbf{     0.10} & \textbf{0} & \textbf{     0.03} &      0.04 \\*
...
\textbf{Smokes} \\*[.1cm]
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.33} & \textbf{     0.47} & 0.34 & . & \textbf{     0.37} &      0.06 & & \highlight{0.19} & \textbf{     0.33} & \textbf{     0.22} & . & 0.19 &      0.01 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.29} & 0.32 & 0.26 & \textbf{     0.07} & 0.28 &      0.02 & & \highlight{0.25} & 0.25 & 0.24 & \textbf{0} & 0.24 &      0.00 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.68} & \textbf{     0.27} & \textbf{     0.95} & . & \textbf{     0.42} &      0.18 & & \highlight{0.67} & \textbf{     0.25} & \textbf{     0.80} & . & \textbf{     0.32} &      0.11 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{19.43} & \textbf{    17.90} & \textbf{    17.59} & . & \textbf{    17.55} &      0.11 & & \highlight{16.29} & \textbf{    15.00} & \textbf{    15.36} & . & \textbf{    15.38} &      0.01 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{14.45} & \textbf{    17.22} & 11.41 & \textbf{    12.65} & \textbf{    16.54} &      0.16 & & \highlight{16.61} & \textbf{    20.00} & 13.75 & \textbf{    15.00} & \textbf{    19.33} &      0.12 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{23.85} & \textbf{    19.23} & \textbf{    30.86} & . & \textbf{    12.69} &      0.42 & & \highlight{25.00} & \textbf{    21.67} & \textbf{    30.00} & . & \textbf{    15.58} &      0.23 \\*
...
\textbf{BMI} \\*[.1cm]
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{24.75} & 23.63 & \textbf{    24.49} & \textbf{    26.89} & \textbf{    24.53} &      0.11 & & \highlight{24.34} & 23.08 & \textbf{    24.13} & \textbf{    26.83} & \textbf{    24.04} &      0.04 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{25.19} & \textbf{    23.72} & \textbf{    25.52} & 28.20 & \textbf{    26.07} &      0.07 & & \highlight{24.84} & \textbf{    23.04} & \textbf{    25.03} & 27.61 & \textbf{    25.59} &      0.06 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{24.55} & \textbf{    25.28} & \textbf{    25.63} & \textbf{    23.55} & 26.17 &      0.12 & & \highlight{25.14} & \textbf{    25.82} & \textbf{    25.38} & \textbf{    23.31} & \textbf{    25.95} &      0.03 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{4.29} & \textbf{     4.14} & \textbf{     4.48} & \textbf{     4.98} & \textbf{     4.19} &      0.17 & & \highlight{4.27} & \textbf{     4.15} & 4.48 & \textbf{     5.00} & \textbf{     4.15} &      0.04 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{3.67} & \textbf{     3.55} & \textbf{     3.77} & \textbf{     3.73} & \textbf{     3.50} &      0.12 & & \highlight{3.96} & \textbf{     3.89} & \textbf{     4.07} & 4.00 & \textbf{     3.86} &      0.02 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{2.84} & \textbf{     3.33} & \textbf{     2.76} & 4.96 & \textbf{     3.06} &      0.22 & & \highlight{3.17} & \textbf{     3.67} & \textbf{     3.00} & 5.00 & \textbf{     3.32} &      0.14 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{1.22} & 0.92 & \textbf{     1.06} & \textbf{     0.83} & 0.98 &      0.06 & & \highlight{1.36} & 1.08 & \textbf{     1.19} & \textbf{     1.00} & 1.13 &      0.04 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{1.20} & \textbf{     1.09} & \textbf{     1.15} & \textbf{     1.09} & \textbf{     1.25} &      0.03 & & \highlight{1.11} & \textbf{     1.00} & \textbf{     1.07} & \textbf{     1.00} & \textbf{     1.14} &      0.01 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{1.31} & 1.26 & \textbf{     1.41} & 1.18 & \textbf{     1.68} &      0.09 & & \highlight{1.20} & 1.17 & \textbf{     1.10} & \textbf{     1.00} & \textbf{     1.36} &      0.02 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0.02} & 0.03 & \textbf{     0.07} & \textbf{    -0.05} & 0.21 &      0.09 & & \highlight{0.07} & 0.08 & \textbf{     0.11} & \textbf{0} & 0.26 &      0.05 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{-0.03} & \textbf{     0.03} & \textbf{    -0.04} & \textbf{    -0.09} & 0.07 &      0.08 & & \highlight{0.07} & \textbf{     0.11} & \textbf{     0.03} & \textbf{0} & 0.16 &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{0} & \textbf{     0.17} & 0.21 & 0.02 & \textbf{     0.03} &      0.10 & & \highlight{0} & \textbf{     0.17} & 0.20 & 0 & \textbf{     0.03} &      0.07 \\*
...
\quad \quad \textbf{Adult 30} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{10.94} & \textbf{     8.45} & \textbf{    12.39} & \textbf{    20.94} & 11.25 &      0.20 & & \highlight{13.76} & \textbf{    11.54} & \textbf{    14.73} & \textbf{    25.00} & 13.74 &      0.03 \\*
...
\\
\quad \quad \textbf{Adult 40} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{14.51} & \textbf{    11.14} & \textbf{    15.66} & \textbf{    16.74} & 14.56 &      0.12 & & \highlight{13.13} & \textbf{     9.78} & \textbf{    14.26} & \textbf{    14.33} & \textbf{    12.48} &      0.02 \\*
...
\\
\quad \quad \textbf{Adult 50} \\*[.1cm]
\quad \quad \quad Reggio& \highlight{13.92} & 13.52 & \textbf{    15.48} & \textbf{    12.62} & \textbf{    14.42} &      0.13 & & \highlight{16.00} & 15.67 & \textbf{    16.50} & \textbf{    13.00} & \textbf{    15.25} &      0.01 \\*
