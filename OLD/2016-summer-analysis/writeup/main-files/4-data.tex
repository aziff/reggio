...
\input{tables/children_OUTCOMEasilo.tex}
...
\input{tables/sumX-asilo-pre.tex}  
\input{tables/adolescent_OUTCOMEasilo.tex}
\input{tables/sumX-post.tex}  
%\end{table}
...
\input{tables/sumX-asilo-pre.tex}  
\input{tables/adults_OUTCOMEasilo.tex}
\input{tables/sumX-post.tex}  
%\end{table}
...
\input{./tables/children_OUTCOMEmaterna.tex}
\input{./tables/sumX-post.tex}  
%\end{table}
%
...
\input{./tables/sumX-materna-pre.tex}  
\input{./tables/adolescent_OUTCOMEmaterna.tex}
\input{./tables/sumX-post.tex}  
%\end{table}
%
%%% adults, preschool
...
\input{./tables/sumX-materna-pre.tex}  
\input{./tables/adults_OUTCOMEmaterna.tex}
\input{./tables/sumX-post.tex}  
%\end{table}
