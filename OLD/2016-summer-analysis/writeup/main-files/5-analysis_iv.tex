...
\input{tables/sumX-asilo-pre.tex}
\input{tables/children_PREasilo.tex}
\input{tables/sumX-post.tex}  
%\end{table}
...
\input{tables/sumX-asilo-pre.tex}  
\input{tables/adolescents_PREasilo.tex}
\input{tables/sumX-post.tex}  
%\end{table}
...
\input{tables/sumX-asilo-pre.tex}  
\input{tables/adults_PREasilo.tex}
\input{tables/sumX-post.tex}  
%\end{table}
...
\input{./tables/sumX-materna-pre.tex}  
\input{./tables/children_PREmaterna.tex}
\input{./tables/sumX-post.tex}  
%\end{table}
%
...
\input{./tables/sumX-materna-pre.tex}  
\input{./tables/adolescent_PREmaterna.tex}
\input{./tables/sumX-post.tex}  
%\end{table}
%
%%% adults, preschool
...
\input{./tables/sumX-materna-pre.tex}  
\input{./tables/adults_PREmaterna.tex}
\input{./tables/sumX-post.tex}  
%\end{table}
...
\input{../Output/iv_texAsiloChildCH_short.tex}  
\end{table}
\begin{table}[H]
\caption{Pooled: Child Health - Preschool, Child}
\input{../Output/iv_texMaternaChildCH_short.tex}
\end{table}

%------------------- SDQ ----------------------%
\begin{table}[H]
\caption{Pooled: Child SDQ Score - Infant-toddler center, Child}
\input{../Output/iv_texAsiloChildCS_short.tex}  
\end{table}
\begin{table}[H]
...
%\input{../Output/iv_texMaternaChildLS_short.tex}
%\end{table}
%%------------------- Like Math ----------------------%
%\begin{table}[H]
...
%\input{../Output/iv_texMaternaChildDIFF_short.tex}
%\end{table}
%%------------------- Difficulties Seated ----------------------%
%\begin{table}[H]
...
%\input{../Output/iv_texMaternaChildDS_short.tex}
%\end{table}
%%------------------- Difficulties Obey ----------------------%
%\begin{table}[H]
...
\input{../Output/iv_texAsiloAdolCH_short.tex}  
\end{table}
\begin{table}[H]
\caption{Pooled: Child Health - Preschool, Adolescent}
\input{../Output/iv_texMaternaAdolCH_short.tex}
\end{table}
...
%\input{../Output/iv_texMaternaAdolH_short.tex}
%\end{table}
...
%\input{../Output/iv_texMaternaAdolS_short.tex}
%\end{table}
%
%------------------- Depression ----------------------%
\begin{table}[H]
\caption{Pooled: Depression - Infant-toddler center, Adolescent}
\input{../Output/iv_texAsiloAdolD_short.tex}
\end{table}
\begin{table}[H]
...
\input{../Output/iv_texMaternaAdolM_short.tex}
\end{table}
...
%\input{../Output/iv_texAsiloAdolLM_short.tex}  
%\end{table}
%\begin{table}[H]
...
%\input{../Output/iv_texAsiloAdolLL_short.tex}  
%\end{table}
%\begin{table}[H]
%\caption{Pooled: Adol likes reading - Preschool, Adolescent}
%\input{../Output/iv_texMaternaAdolLL_short.tex}
%\end{table}
%%------------------- Difficulties ----------------------%
%\begin{table}[H]
...
%\input{../Output/iv_texMaternaAdolDE_short.tex}
%\end{table}
%%------------------- Difficulties Interest ----------------------%
%\begin{table}[H]
...
%\input{../Output/iv_texMaternaAdolDI_short.tex}
%\end{table}
...
\input{../Output/iv_texAsiloAdultH_short.tex}
\end{table}
\begin{table}[H]
...
\input{../Output/iv_texAsiloAdultD_short.tex}
\end{table}
\begin{table}[H]
\caption{Pooled: Depression - Preschool, Adult}
\input{../Output/iv_texMaternaAdultD_short.tex}
\end{table}
...
\input{../Output/iv_texAsiloAdultM_short.tex}
\end{table}
\begin{table}[H]
\caption{Pooled: Bothered by immigrants - Preschool, Adult}
\input{../Output/iv_texMaternaAdultM_short.tex}
\end{table}
